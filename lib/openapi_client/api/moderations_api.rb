  ...
  class ModerationsApi
    ...
    def create_moderation_with_http_info(create_moderation_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ModerationsApi.create_moderation ...'
      end
      ...
      if @api_client.config.client_side_validation && create_moderation_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_moderation_request' when calling ModerationsApi.create_moderation"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ModerationsApi.create_moderation",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ModerationsApi#create_moderation\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
