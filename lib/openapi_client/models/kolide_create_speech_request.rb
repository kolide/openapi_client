...
module OpenapiClient
  class KolideCreateSpeechRequest
    attr_accessor :model
    ...
    def self.openapi_types
      {
        :'model' => :'KolideCreateSpeechRequestModel',
        :'input' => :'String',
        :'voice' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::KolideCreateSpeechRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::KolideCreateSpeechRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      response_format_validator = EnumAttributeValidator.new('String', ["mp3", "opus", "aac", "flac"])
    ...
    def response_format=(response_format)
      validator = EnumAttributeValidator.new('String', ["mp3", "opus", "aac", "flac"])
    ...
    def speed=(speed)
      ...
      if speed > 4.0
        fail ArgumentError, 'invalid value for "speed", must be smaller than or equal to 4.0.'
      end
