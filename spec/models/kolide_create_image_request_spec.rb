...
# Unit tests for OpenapiClient::KolideCreateImageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::KolideCreateImageRequest do
  let(:instance) { OpenapiClient::KolideCreateImageRequest.new }

  describe 'test an instance of KolideCreateImageRequest' do
    it 'should create an instance of KolideCreateImageRequest' do
      expect(instance).to be_instance_of(OpenapiClient::KolideCreateImageRequest)
    end
  end
