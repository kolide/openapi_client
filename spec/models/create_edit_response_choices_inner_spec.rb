...
# Unit tests for OpenapiClient::CreateEditResponseChoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateEditResponseChoicesInner do
  let(:instance) { OpenapiClient::CreateEditResponseChoicesInner.new }
  ...
  describe 'test an instance of CreateEditResponseChoicesInner' do
    it 'should create an instance of CreateEditResponseChoicesInner' do
      expect(instance).to be_instance_of(OpenapiClient::CreateEditResponseChoicesInner)
    end
  end
