...
# Unit tests for OpenapiClient::KolideFineTuningJob
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::KolideFineTuningJob do
  let(:instance) { OpenapiClient::KolideFineTuningJob.new }

  describe 'test an instance of KolideFineTuningJob' do
    it 'should create an instance of KolideFineTuningJob' do
      expect(instance).to be_instance_of(OpenapiClient::KolideFineTuningJob)
    end
  end
