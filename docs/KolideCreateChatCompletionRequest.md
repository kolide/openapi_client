# OpenapiClient::KolideCreateChatCompletionRequest

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **messages** | [**Array&lt;KolideChatCompletionRequestMessage&gt;**](KolideChatCompletionRequestMessage.md) | A list of messages comprising the conversation so far. [Example Python code](https://cookbook.openai.com/examples/how_to_format_inputs_to_chatgpt_models). |  |
| **model** | [**KolideCreateChatCompletionRequestModel**](KolideCreateChatCompletionRequestModel.md) |  |  |
...
| **response_format** | [**KolideCreateChatCompletionRequestResponseFormat**](KolideCreateChatCompletionRequestResponseFormat.md) |  | [optional] |
...
| **stop** | [**KolideCreateChatCompletionRequestStop**](KolideCreateChatCompletionRequestStop.md) |  | [optional] |
...
| **tools** | [**Array&lt;KolideChatCompletionTool&gt;**](KolideChatCompletionTool.md) | A list of tools the model may call. Currently, only functions are supported as a tool. Use this to provide a list of functions the model may generate JSON inputs for.  | [optional] |
| **tool_choice** | [**KolideChatCompletionToolChoiceOption**](KolideChatCompletionToolChoiceOption.md) |  | [optional] |
| **user** | **String** | A unique identifier representing your end-user, which can help OpenAI to monitor and detect abuse. [Learn more](/docs/guides/safety-best-practices/end-user-ids).  | [optional] |
| **function_call** | [**KolideCreateChatCompletionRequestFunctionCall**](KolideCreateChatCompletionRequestFunctionCall.md) |  | [optional] |
| **functions** | [**Array&lt;KolideChatCompletionFunctions&gt;**](KolideChatCompletionFunctions.md) | Deprecated in favor of &#x60;tools&#x60;.  A list of functions the model may generate JSON inputs for.  | [optional] |
...
instance = OpenapiClient::KolideCreateChatCompletionRequest.new(
  messages: null,
  model: null,
